...
## Written by Vishnu Paramasivam <vishnu_paramasivam@ime.a-star.edu.sg>, March 2019
## Description: Joules power computation script, requires VCD stimulus and netlist.
...
set rtl_list "flex_final_4x4_optimized_14/globals_top.vh flex_final_4x4_optimized_14/flex.sv flex_final_4x4_optimized_14/tile_no_ldst.sv flex_final_4x4_optimized_14/tile_ldst.sv flex_final_4x4_optimized_14/iterCounter.sv flex_final_4x4_optimized_14/ls_add_unit.sv flex_final_4x4_optimized_14/simple_alu.sv  flex_final_4x4_optimized_14/router.sv flex_final_4x4_optimized_14/xbar_bypass.sv encoder_onehot.sv pace_clkgate.sv pace_ff_rst.sv flex_final_4x4_optimized_14/configurator.sv"
set f_sdc    "$::env(REPO_ROOT)/syn/hycube.sdc"
...
# preserve RTL hierarchy - following is forced in Joules
# foreach subd [find / -subd *] { set_attribute ungroup_ok false $subd }
#set alu_subd [get_attribute subdesign /$DESIGN/DP/ALU]
#set_attribute dp_csa none $alu_subd
#set_attribute dp_sharing none $alu_subd
